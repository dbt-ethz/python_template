...
1. Fork `the repository <https://github.com/dbt-ethz/{{cookiecutter.project_slug}}>`_ and clone the fork.
...
When `reporting a bug <https://github.com/dbt-ethz/{{cookiecutter.project_slug}}/issues>`_
please include:
...
`Github <https://github.com/dbt-ethz/{{cookiecutter.project_slug}}/issues>`_. If you are proposing a feature:
